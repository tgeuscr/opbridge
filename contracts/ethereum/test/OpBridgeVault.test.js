...
describe("OpBridgeVault", function () {
  let compiled;
  ...
  async function deployFixture() {
    ...
    const vaultFactory = factoryFor("OpBridgeVault", compiled, owner);
...
function compileContracts() {
  ...
  const input = {
    ...
    sources: {
      "OpBridgeVault.sol": {
        content: fs.readFileSync(path.join(root, "src/OpBridgeVault.sol"), "utf8"),
      },
      "MockERC20.sol": {
