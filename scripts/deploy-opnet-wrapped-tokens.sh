...
npm run build:husdt --workspace @opbridge/opnet-contracts
npm run build:hwbtc --workspace @opbridge/opnet-contracts
npm run build:heth --workspace @opbridge/opnet-contracts
npm run build:hpaxg --workspace @opbridge/opnet-contracts
