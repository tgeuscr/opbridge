...
write_if_missing "$ENV_DIR/contracts.env" '# Generated by scripts/heptad-env-sync.sh
# Ethereum + OPNet addresses used by relayers and site
'

echo
echo "heptad-env initialized at: $ENV_DIR"
echo "Next: run scripts/heptad-env-sync.sh after deployments to populate contract addresses."
