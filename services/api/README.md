...
- `RELAYER_API_CORS_ALLOWED_ORIGINS` (comma-separated list, supports `*` wildcards, default allows `heptad.app`, `*.vercel.app`, and local Vite origins)
...
- expose `https://api.heptad.app` with Nginx reverse proxy
